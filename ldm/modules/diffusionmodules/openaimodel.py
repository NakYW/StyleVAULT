    ...
    def forward(self,
        ...
        for module in self.output_blocks:
            ...
            if injected_features is not None and q_feature_key in injected_features:
                self_attn_Q_c_injected = injected_features[q_feature_key]

            if injected_features is not None and k_feature_key in injected_features:
                self_attn_K_s_injected = injected_features[k_feature_key]

            if injected_features is not None and v_feature_key in injected_features:
                self_attn_V_s_injected = injected_features[v_feature_key]
            ...
            if injected_features is not None:
                base_config = injected_features[config_key]
                injection_config = dict(base_config)
