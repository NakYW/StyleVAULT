...
def main():
    ...
    # 这里假设风格迁移的代码是在 compute_art_fid 函数里执行
    # 只计算风格迁移，不计算 ArtFID、FID、LPIPS、LPIPS_gray 等
    compute_art_fid(args.tar,
                    args.sty,
                    args.cnt,
                    args.batch_size,
                    args.device,
    ...
    style_elapsed_time = end_style_time - start_style_time

    # 计算 ArtFID、FID、LPIPS、LPIPS_gray 和 CFSD 的值
    ...
    # 输出结果
    print(f"风格迁移部分耗时：{style_elapsed_time:.4f}秒")
